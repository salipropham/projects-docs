 ...
 */
class Auth_Group_Agroup extends \Auth\Auth_Group_Driver
{

    protected static $_valid_groups = array();

    public static $config_file = 'auth_admin';

    protected $config = array(
        'drivers' => array('acl' => array('Aacl'))
    );

    public static function _init()
    {

        static::$_valid_groups = array_keys(\Config::get(static::$config_file.'.groups', array()));
    }
    ...
    public function get_name($group = null)
    {
        ...
        return \Config::get(static::$config_file.'.groups.' . $group . '.name', null);
    }
    ...
    public function get_roles($group = null)
    {
        ...
        $groups = \Config::get(static::$config_file.'.groups');
